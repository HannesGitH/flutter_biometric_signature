...
* **Breaking**: Configuration objects (`AndroidConfig`, `IosConfig`, `MacosConfig`) are now immutable data classes generated by Pigeon.
...
### Fixed
* Addressed potential concurrency issues in Android key generation using Kotlin Coroutines.
* Unified iOS and macOS implementation logic under the same Swift protocol.
